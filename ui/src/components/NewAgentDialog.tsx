...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      description: "(descreva aqui qual tipo de agente você quer)",
    });
  }
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Recomendamos deixar seu CEO cuidar da configuração do agente —
                  ele conhece a estrutura da empresa e configura hierarquia,
                  permissões e adaptadores.
                </p>
              </div>
